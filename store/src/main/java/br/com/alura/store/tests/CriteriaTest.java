...
public class CriteriaTest {
    ...
    public static void main(String[] args) {
        ...
        productDao.findByOldOptionalParameters(null, new BigDecimal(700), LocalDate.now());
        productDao.findByCriteriaOptionalParameters(null, new BigDecimal(700), LocalDate.now());
